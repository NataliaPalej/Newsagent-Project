...
INSERT INTO publications (title, issueNo, author, price, stock) VALUES
    ('West', 100, 'John Doe', 2.99, 5),
    ('Cosmo', 123, 'John Smith', 1.99, 350),
    ('Galactic', 456, 'Jane Doe', 3.99, 4),
    ('Almanac', 789, 'Michael Johnson', 2.99, 10),
    ('Horizon', 321, 'John Doe', 2.99, 150),
    ('Quantum', 50, 'Alice White', 5.99, 6),
    ('Innovator', 200, 'David Green', 3.99, 250),
    ('Stellar', 789, 'Emily Brown', 4.99, 4),
    ('Global', 150, 'Robert Black', 2.50, 2),
    ('Bio', 300, 'Sophia Gray', 3.50, 0),
    ('Cultural', 75, 'Daniel Lee', 2.75, 5),
    ('Trends', 400, 'Olivia Davis', 4.99, 10),
    ('Sustain', 250, 'Matthew Johnson', 3.99, 15),
    ('Robo', 600, 'Ava Robinson', 3.75, 16),
    ('PI', 100, 'Liam Miller', 2.25, 22);
