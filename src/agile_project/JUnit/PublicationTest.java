...
//	}
	...
	public void testCreatePublication001() throws RonanException, SQLException, NataliaException {
		try {
			...
			assertEquals(1, createTest001.getPrice());
