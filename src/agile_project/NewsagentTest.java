...
public class NewsagentTest extends TestCase {
	 ...
	 * Inputs: firstName = Test, lastName = Test, address = Test, phoneNo = 111-111-1111, areaCode = 1
	...
	public void testCreateCustomer001() throws NataliaException {
		try {
			...
			customer.createCustomer("Test", "Test", "Test", "111-111-1111", 1);
	 ...
	 * Inputs: firstName = "", lastName = Test, address = Test, phoneNo = 111-111-1111, areaCode = 1
	 * Output: Invalid first name. Name must be between 1-15 characters.
	 */
	public void testCreateCustomer002() throws NataliaException {
		try {
			Newsagent customer = new Newsagent();
			customer.createCustomer("", "Test", "Test", "111-111-1111", 1);
	        // Retrieve custID that was auto generated
	        int autoGeneratedCustID = customer.getCustID();
	        // Check that cust was created 
	        assertTrue(autoGeneratedCustID > 0);
	        ...
	        assertEquals("111-111-1111", customer.getPhoneNo());
	        assertEquals(1, customer.getAreaCode());
	        fail("Exception expected. Invalid first name");
		}catch (NataliaException | SQLException e) {
	 ...
	 * Inputs: firstName = Test, lastName = "", address = Test, phoneNo = 111-111-1111, areaCode = 1
	...
	public void testCreateCustomer003() throws NataliaException {
		try {
			Newsagent customer = new Newsagent();
			customer.createCustomer("Test", "", "Test", "111-111-1111", 1);
			fail("Exception expected. Invalid last name");
		}catch (NataliaException | SQLException e) {
	 ...
	 * Inputs: firstName = Test, lastName = Test, address = "", phoneNo = 111-111-1111, areaCode = 1
	...
	public void testCreateCustomer004() throws NataliaException {
		try {
			Newsagent customer = new Newsagent();
			customer.createCustomer("Test", "Test", "", "111-111-1111", 1);
			fail("Exception expected. Invalid address");
		}catch (NataliaException | SQLException e) {
	 ...
	 * Inputs: firstName = Test, lastName = Test, address = Test, phoneNo = 1111111111, areaCode = 1
	...
	public void testCreateCustomer005() throws NataliaException {
		try {
			Newsagent customer = new Newsagent();
			customer.createCustomer("Test", "Test", "Test", "1111111111", 1);
			fail("Exception expected. Invalid phoneNo");
		}catch (NataliaException | SQLException e) {
